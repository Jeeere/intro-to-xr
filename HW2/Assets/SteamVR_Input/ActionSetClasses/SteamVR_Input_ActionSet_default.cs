...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Boolean RotationalTrack
        {
            get
            {
                return SteamVR_Actions.default_RotationalTrack;
            }
        }
        
        public virtual SteamVR_Action_Boolean PositionalTrack
        {
            get
            {
                return SteamVR_Actions.default_PositionalTrack;
            }
        }
